...
import "./index.css";
import "../src/customer/user/components/userOrder.css";
import App from "./App";
import { Route, BrowserRouter as Router, Routes } from "react-router-dom";
import Product from "./customer/features/product/components/product";
...
import ProductDetail from "./customer/features/product/components/productDetails";
import Encryption from "./ecommerce-products-data-master/encryption";
...
import StripeCheckout from "./customer/pages/stripeCheckout";
...
import ColorPicker from "./customer/pages/colorPicker";
import ScrollButton from "./customer/pages/scrollButton";
import PaymentSuccessPage from "./customer/pages/paymentSuccess";
import StripeCheckoutPayment from "./customer/pages/stripeCheckoutPayment";
